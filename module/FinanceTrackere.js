export default class FinanceTracker {
    ...
    load() {
        const entries = JSON.parse(localStorage.getItem("finance-tracker-entries-dev") || "[]");
    ...
    updateSummary() {
        ...
        this.root.querySelector(".total").textContent = "₹ "+total;
    }
    ...
    save() {
        ...
        localStorage.setItem("finance-tracker-entries-dev", JSON.stringify(data));
        this.updateSummary();
    }

    addEntry(entry = {}) {
        this.root.querySelector(".entries").insertAdjacentHTML("beforeend", FinanceTracker.entryHtml());
